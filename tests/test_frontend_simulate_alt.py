"""
Reproduce exact frontend simulate knock flow with alternate ports.
Run: python3 tests/test_frontend_simulate_alt.py
"""
...
def main():
    config = {
        ...
        "api_host": "127.0.0.1",
        "api_port": 18080,
        "log_file": "logs/frontend_simulate_alt.log"
    }
